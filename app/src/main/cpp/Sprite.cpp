...
void Sprite::draw(Vertex *vertex, float timeStep) {
    ...
    GLfloat v1 = GLfloat(currentFrameY * SpriteHeight) / GLfloat(SpriteHeight);
    GLfloat v2 = GLfloat((currentFrameY + 1) * SpriteHeight) / GLfloat(SpriteHeight);
    vertex[0].x = posX1; vertex[0].y = posY1; vertex[0].u = u1; vertex[0].v = v1;
    vertex[1].x = posX1; vertex[1].y = posY2; vertex[1].u = u1; vertex[1].v = v2;
    vertex[2].x = posX2; vertex[2].y = posY1; vertex[2].u = u2; vertex[2].v = v1;
    vertex[3].x = posX2; vertex[3].y = posY2; vertex[3].u = u2; vertex[3].v = v2;
